#===============================================================================
# PROJETO CULTURA EM N?MEROS - EIXO 1 (ESTADOS) - SCRIPT FINAL E CORRIGIDO
#===============================================================================
library(tidyverse)
library(arrow)
library(scales)
...
# Configura??o de caminhos e paleta
paleta_cores <- c(
...
tabela_uf_final <- df_tabela_uf_real %>%
  ...
  tab_header(title = md("**Investimento Cultural Estadual Real por UF e Fonte de Recurso**"),
             subtitle = "Valores Empenhados em **R$ Milh?es** | Corrigidos pela Infla??o (Pre?os M?dios de 2024)") %>%
...
# 8. RECEITA CORRENTE L?QUIDA E PAINEL DE ESFOR?O FISCAL -----------------------
